...
const rotasPortal = require('./src/routes/portal');
...
// [refatoracao 5c] 15 rotas /movatak/app/* (portal do cliente) -> src/routes/portal.js (registradas por rotasPortal.register no boot)
...
// Sincronização de leitura CRM -> WhatsApp movida para src/leitura.js (para ser
// reutilizada também pelo registro de conversa, sem dependência circular). Agora
// espelha o estado nao_lida do CRM e tem trava anti-spam por zap_lido_msg_id.
const { marcarChatLidoNoZap, marcarChatNaoLidoNoZap } = require('./src/leitura');
...
// [refatoracao 5c] Registra as rotas /movatak/app/* (movidas para
// src/routes/portal.js). Chamado no fim do boot, quando todos os middlewares,
// helpers e modulos ja estao definidos. deps = tudo que os handlers do portal
// referenciam e que ainda vive no index.js ou em modulos ja extraidos.
rotasPortal.register(app, {
